$(document).ready(function () {
    // Initialize jquery.localtime
    $.localtime.setFormat('YYYY-MM-DD HH:mm:ss');

    // Function to update local time
    function updateLocalTime() {
        var localTimeString = $.localtime.toLocalTime(new Date());
        $('#localTime').text(localTimeString);
    }

    // Update local time initially
    updateLocalTime();

    // Update local time every second (or as needed)
